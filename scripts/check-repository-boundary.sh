...
expected_crates=$'lenso-access-control-agent-tools-plugin\nlenso-access-control-core\nlenso-access-control-d1-plugin\nlenso-access-control-postgres-plugin\nlenso-access-control-workers-smoke\nlenso-capability-access-control\nlenso-capability-access-control-admin\nlenso-capability-access-control-directory'
